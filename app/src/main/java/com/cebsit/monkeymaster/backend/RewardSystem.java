...
import mymou.preferences.PrefsManager;
...
public class RewardSystem {
    ...
    private static String TAG = "RewardSystem";
...
//    private static PrefsManager prefsManager;
    ...
    public static void connectToBluetooth() {
        ...
        if (new PrefsManager(context).bluetooth) {  // Has user activated bluetooth in settings?
    ...
    private static void stopAllChannels() {
        for (int i=0; i<PrefsManager.num_reward_chans; i++) {
            stopChannel(i);
        }
    }
    ...
    public static void stopChannel(int Ch) {
        ...
        sendData(PrefsManager.strobes_off[Ch]);
    }

    public static void startChannel(int Ch) {
        Log.d(TAG, "Starting channel "+Ch);
        sendData(PrefsManager.strobes_on[Ch]);
    }
    ...
    private static void initialiseRewardChannelStrings() {
        ...
        PrefsManager.RewardStrobeChannels();
    }
